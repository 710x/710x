...
![My Skills](https://skillicons.dev/icons?i=nodejs,js,ts,java,python,csharp,docker,postman,git,mongo,express,nest,mysql,graphql,vscode,md,supabase,bots,gcp,postgres,prisma,kafka,nginx,redis)
